...
//                    Log.d(TAG,"addOnGlobalLayoutListener 可以滚动" );
    ...
    protected void bindOnItemClickListener(BaseViewHolder holder, int position) {
        if (onItemClickListener != null) {
            ...
            holder.itemView.setOnClickListener(v -> onItemClickListener.onItemClick(BaseRecyclerAdapter.this, v, (Integer) v.getTag()));
        }
    }
    ...
    protected void bindItemLongClickListener(BaseViewHolder holder, int position) {
        if (onItemLongClickListener != null) {
            ...
            holder.itemView.setTag(position);
            holder.itemView.setOnLongClickListener(v -> onItemLongClickListener.onItemLongClick(BaseRecyclerAdapter.this, v, (Integer) v.getTag()));
        }
    }
