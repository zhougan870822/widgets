package com.zhoug.android.widget.dialog;
...
public class EditDialogFragment extends DialogFragment {
    ...
    /**默认动画 从底部滑出滑入*/
    private @StyleRes int windowAnimationResId=R.style.widgets_anim_window_popu_down;
    /**是否启动动画*/
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(window!=null){
            ...
            window.setBackgroundDrawableResource(R.drawable.widgets_bg_white);
            //默认弹出软键盘
        ...
        //初始化
        View view=inflater.inflate(R.layout.widgets_fragment_edit_dialog,container,false );
        init(view);
